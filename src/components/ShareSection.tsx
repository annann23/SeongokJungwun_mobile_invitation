...
export default function InvitationSection() {
    ...
    const copyLink = async () => {
        try {
            await navigator.clipboard.writeText('https://www.nebula-wedding-invitation.com/');
        } catch (err) {
    ...
    return (
        <section className="h-[300px] gap-10 flex items-center justify-center relative" style={{ backgroundColor: '#ffffff' }}>
