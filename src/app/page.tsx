...
export default function Home() {
  ...
  const twinkleAnimation =
    isIOS || isSafari
      ? "textTwinkleIOS 3s infinite ease-in-out"
      : "textTwinkle 3s infinite ease-in-out";
  ...
  return (
    ...
    >
      <audio ref={audioRef} src="/music/invitation_bgm.mp3" preload="auto" />
      ...
      <div className="relative min-h-screen bg-black text-white">
        ...
        <div className="relative h-[calc(100lvh)] flex flex-col justify-center items-center text-center z-30">
          <div
            className="font-waterfall text-white"
            style={{
              height: "96px",
              lineHeight: "96px",
              display: "flex",
          ...
          <span className="text-[#ffffff] opacity-10 text-[14px] font-waterfall absolute bottom-[30px] right-[30px]">
            made by jungwun
          </span>
        </div>
