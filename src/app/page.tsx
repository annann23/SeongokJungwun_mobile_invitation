    ...
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <div className='min-h-screen flex flex-col items-center justify-center bg-white text-black py-20 font-gowun-dodum'>
        <m.h1 
          ...
          <m.h3 className='text-black text-xl text-center mb-8'>저희 커플을 소개합니다</m.h3>
          <m.div className='text-black text-md text-center mb-12'> 
          ...
          <m.div className='text-black text-md text-center mb-8'>
            채종재 · 강외숙의 든든한 첫째
